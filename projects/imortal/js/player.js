...
jQuery.fn.immortalPlaylist = function(options) {
 
  // default settings
  var options = jQuery.extend( {
    holderId: 'video-playerbox',
	playerHeight: '314',
	playerWidth: '564',
	addThumbs: false,
	thumbSize: 'small',
  ...
  return this.each(function() {
		...
		if(options.addThumbs) {
			...
			selector.children().each(function(i){
				...
				$(this).children("a").empty().html("<img src='"+thumbUrl+"' alt='"+replacedText+"' />" + "<p>" + replacedText + "</p>").attr("title", replacedText);
